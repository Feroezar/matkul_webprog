  ...
  <body>
      ...
      <div class="container-fluid d-flex flex-column align-items-center p-4">
        ...
        <div class="row pb-4 justify-content-center">
          ...
          <div class="col-8 text-center">
            ...
            harum explicabo est? Aperiam dolore asperiores reiciendis debitis
            tempora optio itaque quam quasi dolorum aliquid? Quae natus
            perferendis atque laborum!
          </div>
          <div class="col-2"></div>
        </div>
      </div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6">
            ...
            <p>
              ...
              fugit quod cumque provident quasi! Ut minus veritatis sed atque,
              aut modi fugit? Veniam quos voluptatum harum cumque vero, numquam
              dolore! [ <a href="detailblog.html">Baca Selengkapnya</a> ]
            </p>
            <hr />
          </div>
        </div>
        <div class="row mb-4">
          ...
          <div class="col-md-6">
            ...
            <p>
              ...
              fugit quod cumque provident quasi! Ut minus veritatis sed atque,
              aut modi fugit? Veniam quos voluptatum harum cumque vero, numquam
              dolore! [ <a href="#">Baca Selengkapnya</a> ]
            </p>
            <hr />
          </div>
        </div>
    ...
    <section id="contactus" class="bg-light">
      <div class="container p-4">
        <h1 class="text-primary text-opacity-100 text-center pb-3">
          === Contact Us ===
        </h1>
        <div class="row">
          ...
          <div class="col col-lg-7">
            <form action="#">
              <div class="row mb-3">
                <label for="staticEmail" class="col-md-3 form-label"
                  >Email</label
                >
                <div class="col-md-9">
                  <input
              ...
              <div class="row mb-3">
                <label for="nama`" class="col-md-3 form-label"
                  >Nama Lengkap</label
                >
                <div class="col-md-9">
