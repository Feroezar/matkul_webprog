      ...
      <div class="container d-flex flex-column align-items-center p-4">
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-10">
            ...
            <div class="mb-2">
              <span class="fs-6"
                ><i class="bi bi-calendar"></i> 10/11/2011, Created By :
                Aninur</span
              >
              <hr />
            </div>
            ...
            <p class="justify-content-evenly">
              ...
              fugit quod cumqloremue Lorem, ipsum dolor sit amet consectetur
              adipisicing elit. Perferendis saepe, nobis aspernatur molestiae
              sequi aperiam neque. Et deleniti nostrum odit impedit ex. Possimus
              doloribus nemo officia aspernatur, nam dolorem vero. provident
              quasi! Ut minus veritatis sed atque, aut modi fugit? Veniam quos
              voluptatum harum cumque vero, numquam dolore! Lorem ipsum dolor
              sit amet, consectetur adipisicing elit. Maxime reprehenderit
              aliquam natus non. Laudantium ex quos laboriosam, laborum nemo
              blanditiis, placeat eligendi sequi eius voluptatibus eum illum
              amet quisquam sit. Lorem ipsum, dolor sit amet consectetur
              adipisicing elit. Ducimus architecto perspiciatis odio voluptas
              deserunt enim ullam velit itaque at, illo iste dolor
              exercitationem magnam fugit pariatur praesentium facere in.
              Ullam?Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Odio cupiditate veniam a hic quia fugiat, modi aspernatur
              molestias sapiente suscipit expedita ab temporibus ad quibusdam
              asperiores odit unde, dolores id.
            </p>
            <hr />
          </div>
        </div>
